...
- **Tree inspection**: `get.one.tree()` prints individual tree structures.
...
Use `get.one.tree()` to print the structure of any tree in the fitted forest. This is helpful for understanding how splits are made and for debugging.
